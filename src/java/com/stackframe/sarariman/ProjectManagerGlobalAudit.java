...
/**
 * An Audit which looks for active projects that have no managers.
 *
 * @author mcculley
 */
public class ProjectManagerGlobalAudit implements Audit {

    private final DataSource dataSource;
    private final Projects projects;

    public ProjectManagerGlobalAudit(DataSource dataSource, Projects projects) {
        ...
        try {
            ...
            try {
                PreparedStatement s = c.prepareStatement(
                        ...
                        "FROM projects AS p " +
                        "LEFT OUTER JOIN project_managers AS m ON m.project = p.id " +
                    ...
                    try {
                        ...
                        while (r.next()) {
                            ...
                            AuditResult result = new AuditResult(AuditResultType.error,
                                                                 String.format("project %d (%s) has no managers",
